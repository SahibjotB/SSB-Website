...
export default function Projects() {
  return (
    <div className="min-h-screen px-4 py-12 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
        {projects.map((project, index) => (
          <a
            ...
            className="block p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-md transition-all duration-300 hover:bg-purple-700 hover:text-white dark:hover:bg-purple-700 dark:hover:text-white text-gray-900 dark:text-gray-100"
          >
