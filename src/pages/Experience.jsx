      ...
      <div className="max-w-4xl mx-auto grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2">
        {experiences.map((exp, idx) => (
          <a
            ...
            className="block p-6 bg-neutral-200 dark:bg-neutral-950 rounded-2xl shadow hover:bg-purple-700 hover:text-white dark:hover:bg-purple-700 dark:hover:text-white transition-colors duration-300 text-black dark:text-white"
          >
