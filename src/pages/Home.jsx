...
export default function Home() {
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 flex flex-col items-center justify-center text-white px-4">
      <p className="text-lg mb-2">Hi, I'm</p>
      <h1 className="text-5xl font-bold mb-2">Sahibjot Boyal</h1>
      <p className="text-xl text-white/90 mb-10">Software Developer</p>
